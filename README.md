...
Completed final project is due by 5:00 pm on Tuesday, May 2nd.
...
1. We have included a very bare template, `project.ipynb` which only includes basic section headings. Feel free to add, adjust, remove these as needed to fit your specific project, they are included only as general guidelines for structuring your write up.
